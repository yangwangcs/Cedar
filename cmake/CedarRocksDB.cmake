...
foreach(CEDAR_ENGINE_SOURCE_FILE IN LISTS CEDAR_ENGINE_SOURCE_FILES)
    ...
    file(RELATIVE_PATH CEDAR_ENGINE_SOURCE_RELATIVE
         "${CMAKE_SOURCE_DIR}" "${CEDAR_ENGINE_SOURCE_FILE}")
    string(APPEND CEDAR_ENGINE_SOURCE_DIGEST_INPUT
           "|${CEDAR_ENGINE_SOURCE_RELATIVE}:${CEDAR_ENGINE_SOURCE_FILE_SHA256}")
endforeach()
...
string(SHA256 CEDAR_ROCKSDB_FINGERPRINT_INPUT
    "${CEDAR_ENGINE_BASELINE}|${CEDAR_ENGINE_SOURCE_DIGEST}|${CEDAR_ROCKSDB_CODEC_SOURCES}|${CEDAR_ROCKSDB_CODEC_FLAGS}|${CEDAR_ROCKSDB_BUILD_TYPE}|${CMAKE_CXX_COMPILER}|${CMAKE_CXX_COMPILER_ID}|${CMAKE_CXX_COMPILER_VERSION}|${CMAKE_SYSTEM_NAME}|${CMAKE_SYSTEM_PROCESSOR}|${CMAKE_OSX_ARCHITECTURES}|${CMAKE_OSX_DEPLOYMENT_TARGET}|${CEDAR_ROCKSDB_PROFILE}")
string(SUBSTRING "${CEDAR_ROCKSDB_FINGERPRINT_INPUT}" 0 20 CEDAR_ROCKSDB_FINGERPRINT)
set(CEDAR_ROCKSDB_PREFIX
    "${CEDAR_ROCKSDB_CACHE_ROOT}/${CEDAR_ENGINE_BASELINE}-${CEDAR_ROCKSDB_FINGERPRINT}")
...
if(NOT EXISTS "${CEDAR_ROCKSDB_LIBRARY}" OR
   NOT EXISTS "${CEDAR_ROCKSDB_MANIFEST}")
    ...
    set(CEDAR_ROCKSDB_CONFIGURE_COMMAND
        "${CMAKE_COMMAND}" -S "${CEDAR_ENGINE_SOURCE_DIR}" -B "${CEDAR_ROCKSDB_BUILD_DIR}"
