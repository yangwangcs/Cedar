...
class MemTableListVersion {
 public:
  ...
  // A referenced MemTableListVersion is immutable. Cedar's runtime sampler
  // uses these narrow accessors through a referenced SuperVersion so it does
  // not need DBImpl's global mutex merely to observe existing flush debt.
  ...
  bool HasUnflushedMemTable() const { return !memlist_.empty(); }
