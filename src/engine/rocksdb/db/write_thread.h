  ...
  struct Writer {
    ...
    Writer()
        : batch(nullptr),
          ...
          link_newer(nullptr),
          ingest_wbwi(false),
          exclusive_write_group(false),
          cedar_epoch_metrics(nullptr) {}
    ...
    Writer(const WriteOptions& write_options, WriteBatch* _batch,
           ...
           bool _ingest_wbwi = false, bool _exclusive_write_group = false,
           CedarEpochMetrics* _cedar_epoch_metrics = nullptr)
        : batch(_batch),
          ...
          exclusive_write_group(_exclusive_write_group),
          cedar_epoch_metrics(_cedar_epoch_metrics) {}
