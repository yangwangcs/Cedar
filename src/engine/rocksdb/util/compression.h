...
#if !defined(CEDAR_ZSTD_NO_DICTIONARY_TRAINING)
//  For ZDICT_* functions
#include <zdict.h>
#endif
// ZDICT_finalizeDictionary API is exported and stable since v1.4.5
#if ZSTD_VERSION_NUMBER >= 10405 && !defined(CEDAR_ZSTD_NO_DICTIONARY_TRAINING)
...
#if defined(ZSTD) && !defined(CEDAR_ZSTD_NO_DICTIONARY_TRAINING)
